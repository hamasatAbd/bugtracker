package example.bugtracker.config.social;

import example.bugtracker.repository.SocialUserConnectionRepository;
import example.bugtracker.repository.CustomSocialUsersConnectionRepository;
import example.bugtracker.security.jwt.TokenProvider;
import example.bugtracker.security.social.CustomSignInAdapter;
