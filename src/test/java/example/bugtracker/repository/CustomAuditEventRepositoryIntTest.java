package example.bugtracker.repository;

import example.bugtracker.BugtrackerApp;
import example.bugtracker.config.Constants;
import example.bugtracker.config.audit.AuditEventConverter;
import example.bugtracker.domain.PersistentAuditEvent;
...
import static example.bugtracker.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
