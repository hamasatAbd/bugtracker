...
import example.bugtracker.BugtrackerApp;
import example.bugtracker.domain.Authority;
import example.bugtracker.domain.User;
import example.bugtracker.repository.AuthorityRepository;
...
import example.bugtracker.web.rest.errors.ExceptionTranslator;
import example.bugtracker.web.rest.vm.KeyAndPasswordVM;
